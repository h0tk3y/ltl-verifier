...
fun <T, R> descendOrCombine(left: Parser<T>, right: Parser<R>, ifRightPresent: (T, R) -> T): Parser<T> =
        (left and optional(right)).map { (l, r) -> if (r == null) l else ifRightPresent(l, r) }
